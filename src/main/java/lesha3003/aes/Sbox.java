...
public final class Sbox {
    private Sbox(){}
    private static byte[] SBOX = {(byte)0x63, (byte) 0x7c, (byte) 0x77, (byte) 0x7b, (byte) 0xf2, (byte) 0x6b, (byte) 0x6f, (byte) 0xc5, (byte) 0x30, (byte) 0x01, (byte) 0x67, (byte) 0x2b, (byte) 0xfe, (byte) 0xd7, (byte) 0xab, (byte) 0x76, (byte)
    ...
    private static byte[] REVERSE_SBOX = {
    ...
    public static byte sbox(byte arg) {
        int index = arg & 0xFF;
        return SBOX[index];
    }
    public static byte reverseSbox(byte arg) {
        int index = arg & 0xFF;
        return REVERSE_SBOX[index];
    }
}
